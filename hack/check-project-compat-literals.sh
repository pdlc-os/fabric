...
rg -n 'grove|Grove|fabric\.grove|grove_id|groveId|/groves' \
  cmd pkg extras \
  --glob '*.go' \
...
allowed_paths=(
  ...
  "^cmd/project.go$"
  "^cmd/root.go$"
  "^cmd/fabric-broker-repl/main.go$"
  ...
  "^extras/fabric-a2a-bridge/internal/bridge/metrics_test.go$"
  "^extras/fabric-a2a-bridge/internal/bridge/server_test.go$"
  "^extras/fabric-a2a-bridge/internal/bridge/stream_test.go$"
  "^extras/fabric-a2a-bridge/internal/state/state_test.go$"
  "^extras/fabric-chat-app/internal/chatapp/commands_test.go$"
  "^extras/fabric-chat-app/internal/chatapp/notifications_test.go$"
  "^extras/fabric-chat-app/internal/state/state_test.go$"
  "^extras/fabric-telegram/internal/telegram/broker_v2_test.go$"
  ...
  "^pkg/fabrictool/hooks/handlers/status_test.go$"
  ...
  "^extras/fabric-a2a-bridge/cmd/fabric-a2a-bridge/main.go$"
  "^extras/fabric-a2a-bridge/internal/bridge/bridge.go$"
  "^extras/fabric-a2a-bridge/internal/bridge/config.go$"
  "^extras/fabric-a2a-bridge/internal/bridge/executor.go$"
  "^extras/fabric-a2a-bridge/internal/bridge/server.go$"
  "^extras/fabric-chat-app/cmd/fabric-chat-app/main.go$"
  "^extras/fabric-chat-app/internal/chatapp/commands.go$"
  "^extras/fabric-chat-app/internal/chatapp/messenger.go$"
  "^extras/fabric-chat-app/internal/chatapp/notifications.go$"
  "^extras/fabric-chat-app/internal/state/state.go$"
  "^extras/fabric-discord/internal/discord/broker.go$"
  "^extras/fabric-slack/internal/slack/broker.go$"
  "^extras/fabric-slack/internal/slack/broker_test.go$"
  ...
  "^pkg/fabrictool/hooks/handlers/telemetry.go$"
  "^pkg/fabrictool/telemetry/gcp_exporter.go$"
  "^pkg/fabrictool/telemetry/providers.go$"
