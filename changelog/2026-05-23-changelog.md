# Release Notes (2026-05-16 - 2026-05-23)
...
* **[Branding]: Project Rename Polish.** Finalized the transition from "Grove" to "Project" terminology in several key areas, including outbound message topics and UI labels.
