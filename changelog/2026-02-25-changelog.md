...
* **Pathing & Scoping:** Corrected path resolution logic to prevent local-path groves from incorrectly using hub-managed paths, and refined the `fabric delete --stopped` command to strictly scope to the active grove.
