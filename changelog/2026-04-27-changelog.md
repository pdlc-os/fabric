...
* **Container-Script Harness Enhancements:** Enabled `allow_container_script_harnesses` by default and introduced a shared `fabric_harness.py` provisioning helper to simplify harness setup.
