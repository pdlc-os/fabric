...
* **[Configuration]: Credentials Priority.** Ensured that `FABRIC_HUB_TOKEN` and `FABRIC_HUB_ENDPOINT` environment variables correctly override stale `hub.enabled=false` settings in configuration files.
