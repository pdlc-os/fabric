...
* **GCP & Metrics Integration:** Enhanced Google Cloud visibility with a native Cloud Monitoring exporter, trace-log correlation across logging pipelines, and automated injection of `FABRIC_GROVE_ID` and GCP labels (agent/grove) into all log streams.
