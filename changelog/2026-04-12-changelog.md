...
* **Kubernetes In-Cluster Detection:** Added support for automatic detection of the Kubernetes runtime namespace when Fabric is running within a cluster.
...
* **Fabrictool Permissions:** Resolved an issue where home directory ownership was not correctly initialized before privilege dropping in `fabrictool`.
