...
## 🐛 Fixes
* **Template Management:** Resolved an issue where the template harness type remained stale after editing `fabric-agent.yaml` via the web UI. The harness type is now correctly re-detected upon file updates.
