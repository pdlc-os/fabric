...
* **Storage & ID Consistency:** Fixed global grove ID bleed-through issues and unified agent split storage paths under `.fabric/` for deterministic behavior across hub-managed and external groves. Ensured cascading cleanups of templates and configs when a grove is deleted (consolidated from commits fea4588, 6bb2348, a97ebd7, 023a089, 6eaf8dc, 221c736, 75bfcc0, c9d8ddf).
